...
app = Flask(__name__, template_folder=r"C:\Users\ASUS\Machine Learning Section\AI\Recognize Dog vs Cat vs Horse")

# Sử dụng đường dẫn tương đối để dễ bảo trì và tương thích với các hệ thống khác
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
MODEL_PATH = r"C:/Users/ASUS/Machine Learning Section/AI/Recognize Dog vs Cat vs Horse/cat_dog_horse_model.h5"
